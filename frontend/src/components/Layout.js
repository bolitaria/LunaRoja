    ...
    <>
      <Head>
        ...
        <link
          ...
          rel="stylesheet"
        />
        {/* Cargar Google Maps API con Places y Geometry */}
      ...
      <div className="flex flex-col min-h-screen">
        <header className="bg-white shadow-sm w-full" style={{ fontFamily: 'Inter, sans-serif' }}>
          <div className="flex items-center justify-between px-4 py-3">
            <Link href="/" className="flex items-center gap-2 flex-shrink-0">
              <img src="/logo.svg" alt="Logo" className="h-[4.5rem] w-auto" style={{ color: 'transparent' }} />
            ...
            <nav className="hidden md:flex space-x-6 justify-center flex-1 mx-4">
              ...
              <Link href="/chatsGroups" className="text-gray-600 hover:text-red-700 transition flex items-center gap-1">
                Grupos
          ...
          <div className="md:hidden px-4 pb-3 flex flex-wrap gap-2 justify-center">
            ...
            <Link href="/chatsGroups" className="text-gray-600 hover:text-red-700 text-sm flex items-center gap-1">
              Grupos
        ...
        <main className="pt-1 flex-1">{children}</main>
        ...
        <footer className="bg-gray-800 text-white py-10">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-8">
              ...
              <Link href="/contact" className="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-6 rounded-full transition">Suscríbete</Link>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30" onClick={closeFlagPopup}>
          <div className="bg-white rounded-xl shadow-2xl p-8 mx-4 max-w-md text-center" onClick={(e) => e.stopPropagation()}>
            <p className="text-gray-600 text-xl font-medium leading-relaxed">
              Desde el río hasta el mar Palestina vencerá. Y con tu apoyo, Boycott y conciencia, cada día construiremos un mundo más justo 🍉
            </p>
          </div>
        </div>
      )}
