...
export default function Layout({ children, title = 'Voces Palestinas por la Justicia' }) {
  ...
  return (
    <>
      ...
      {/* Contenedor principal que usa flex para forzar el footer abajo */}
      <div className="flex flex-col min-h-screen">
        ...
        <header className="bg-white shadow-sm w-full" style={{ fontFamily: 'Inter, sans-serif' }}>
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <div className="flex items-center space-x-3 flex-shrink-0">
              ...
              {/* Dona → ahora apunta a /donaciones */}
              <Link
                href="/donaciones"
        ...
        {/* Contenido principal – flex-1 para empujar el footer hacia abajo */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center border-t border-gray-700 pt-8">
              ...
              <div className="flex justify-center md:justify-end">
                <div className="text-sm space-y-1.5">
                  ...
                  {/* Transparencia financiera → ahora apunta a /donaciones */}
        ...
        >
          ...
          >
            <p className="text-gray-600 text-xl font-medium leading-relaxed">
              Desde el río hasta el mar Palestina será libre. Y con tu apoyo, Boycott y conciencia, cada día construiremos un mundo más justo 🍉
            </p>
          </div>
        </div>
      )}
