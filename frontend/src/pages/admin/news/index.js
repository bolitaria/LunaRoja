  ...
  return (
    <AdminLayout title="Noticias">
      ...
      <div className="bg-white rounded-2xl shadow-sm border-2 border-gray-300 px-4 py-2.5 mb-6 flex items-center gap-6 text-sm">
        ...
        <button onClick={() => { setFilterStatus('featured'); setCurrentPage(1); }} className="flex items-center gap-1.5 hover:text-fuchsia-700 transition-colors group">
        ...
        <button onClick={() => { setFilterStatus('normal'); setCurrentPage(1); }} className="flex items-center gap-1.5 hover:text-fuchsia-700 transition-colors group">
