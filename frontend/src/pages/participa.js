...
import Link from 'next/link';   // needed for <Link> in the Dona section
  ...
  return (
    <Layout title="Participa - Voces Palestinas por la Justicia">
      ...
      <div className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold text-center mb-12">Participa</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md text-center flex flex-col justify-between h-full">
            <div>
              ...
              <p className="text-gray-600 mb-4">Recibe notificaciones de nuevas actividades y eventos.</p>
            </div>
            {subscribed ? (
          ...
          <div className="bg-white p-6 rounded-lg shadow-md text-center flex flex-col justify-between h-full">
            <div>
              ...
              <p className="text-gray-600 mb-4">Entérate de las últimas novedades y acciones.</p>
            </div>
            <a
          ...
          {/* 3. Dona – ahora con <Link> a /donaciones */}
          <div id="dona" className="bg-white p-6 rounded-lg shadow-md text-center flex flex-col justify-between h-full">
            <div>
              ...
              <p className="text-gray-600 mb-4">Tu contribución nos ayuda a mantener nuestras campañas y acciones.</p>
            </div>
            <Link
              href="/donaciones"
