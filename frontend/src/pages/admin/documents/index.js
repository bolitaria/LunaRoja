  ...
  return (
    <AdminLayout title="Documentos">
      ...
      <ConfirmModal
        ...
        message={deleteTarget && (Array.isArray(deleteTarget) ? `¿Eliminar ${deleteTarget.length} documentos?` : '¿Eliminar este documento?')}
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-gray-400">
          ...
          <p className="text-sm">Sube un nuevo documento.</p>
        </div>
      ) : (
