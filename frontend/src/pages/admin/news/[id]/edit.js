    ...
    <AdminLayout title="Editar Noticia">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-sm lg:w-2/3 space-y-6">
          ...
          <button type="submit" disabled={saving} className="inline-flex items-center gap-1 text-sm bg-fuchsia-600 text-white px-4 py-2 rounded-lg hover:bg-fuchsia-700 disabled:opacity-50 transition-colors">
