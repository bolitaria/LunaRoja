...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    // 🆕 LogosAliados (colaboradores)
    await queryInterface.createTable('LogosAliados', {
      id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
      nombre: { type: Sequelize.STRING(255), allowNull: false },
      url: { type: Sequelize.STRING(255), allowNull: false },
      imagen: { type: Sequelize.STRING(255), allowNull: false },
      createdAt: { type: Sequelize.DATE, allowNull: false, defaultValue: Sequelize.NOW },
      updatedAt: { type: Sequelize.DATE, allowNull: false, defaultValue: Sequelize.NOW },
    });
  },
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.dropTable('LogosAliados');
